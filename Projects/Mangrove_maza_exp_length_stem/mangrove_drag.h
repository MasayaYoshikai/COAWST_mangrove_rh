...
#define TURB_LENGTH_STEM         /*Set stem and root wake length-scale to the stem diameter*/
/*#define TURB_LENGTH_ROOT*/     /*Set stem and root wake length-scale to the root diameter*/
...
/*# define ANA_HUMID*/           /*analytical surface air humidity*/
